...
Singleton {
    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property string panelFamily: "crescent" // "ii", "waffle"
            ...
            property JsonObject bar: JsonObject {
                ...
                property string topLeftIcon: "spark" // Options: "distro" or any icon name in ~/.config/quickshell/Moonsshell/assets/icons
