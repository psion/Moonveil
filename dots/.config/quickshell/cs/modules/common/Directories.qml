...
Singleton {
    ...
    property string tempImages: "/tmp/crescentshell/media/images"
    ...
    property string shellConfig: FileUtils.trimFileProtocol(`${Directories.config}/crescentshell`)
    ...
    property string cliphistDecode: FileUtils.trimFileProtocol(`/tmp/crescentshell/media/cliphist`)
    property string screenshotTemp: "/tmp/crescentshell/media/screenshot"
