...
import qs.modules.cs.background.widgets
import qs.modules.cs.background.widgets.clock
import qs.modules.cs.background.widgets.weather
    ...
    PanelWindow {
        ...
        Item {
            ...
            WidgetCanvas {
                ...
                FadeLoader {
                    shown: Config.options.background.widgets.clock.enable && (!Config.options.background.widgets.clock.showOnlyWhenLocked || GlobalStates.screenLocked)
                    fade: false
